...
public partial class RealEstateWebsiteEntities : DbContext
{
    ...
    public virtual int USP_AddManager_id(Nullable<int> id, Nullable<int> id_manager)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_AddManager_id", idParameter, id_managerParameter);
    }
